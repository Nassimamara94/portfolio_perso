...
{
    if(!isset($_SESSION['membre'])) // si l'indice 'membre' n'est pas définit dans la session,celà veut dire que l'internaute n'est pas passé par la page Connexion, donc n'est pas connecté
    {
        return false;
    }
